...
@section('content')
    ...
    <main id="Details" class="relative flex flex-col rounded-t-[40px] py-5 pb-[10px] gap-4 bg-white z-10">
        ...
        <div id="Features" class="grid grid-cols-2 gap-x-[10px] gap-y-4 px-5">
            ...
            <div class="flex items-center gap-[6px]">
                <img src="{{ asset('assets/images/icons/profile-2user.svg') }}" class="w-[26px] h-[26px] flex shrink-0"
                    alt="icon">
                <p class="text-ngekos-grey">{{ $boardingHouse->capacity }} Orang</p>
            </div>
            <div class="flex items-center gap-[6px]">
        ...
        <div id="TabsContent" class="px-5">
            ...
            <div id="Rules-Tab" class="tab-content flex-col gap-5 hidden">Peraturan kos akan ditampilkan di sini.</div>
            <div id="Contact-Tab" class="tab-content flex-col gap-5 hidden">Kontak pemilik kos akan ditampilkan di sini.
            </div>
            <div id="Rewards-Tab" class="tab-content flex-col gap-5 hidden">Hadiah atau promo akan ditampilkan di sini.
            </div>
        </div>
    </main>
