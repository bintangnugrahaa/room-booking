...
@section('content')
    ...
    <div class="relative flex flex-col gap-[30px] my-[60px] px-5">
        <h1 class="font-bold text-[30px] leading-[45px] text-center">Jelajahi Koskos<br>Indah Kami</h1>
        <form action="{{ route('find-kos.results') }}"
            ...
            <div id="InputContainer" class="flex flex-col gap-[18px]">
                ...
                <button type="submit"
                    class="flex w-full justify-center rounded-full p-[14px_20px] bg-ngekos-orange font-bold text-white">Jelajahi
                    Sekarang</button>
            </div>
        </form>
    </div>
